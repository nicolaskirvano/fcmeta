---
author: "FutQuant"
pubDatetime: 2026-07-29T19:25:18.000Z
...
faq:
  - q: "Qual a melhor carta para investir hoje (29/07/2026) no EA FC?"
    a: "Alessia Russo (90, sem liga) lidera, com +69.6% em 7 dias a 96k coins no PC. A lista mede momentum e deve ser confirmada com uma cotação atual antes da compra."
...
> 🔝 **Destaque:** Alessia Russo (90) acumula **+69.6% em 7 dias** a 96k coins; leitura atual: **esticada**.
...
- A mediana é de **+23.6% em 24h** e **+48.7% em 7 dias**.
...
| --- | --- | --- | --- | --- | --- | --- |
| Alessia Russo | 90 | — | 96k coins | +14% | +69.6% | Esticada |
| Lautaro Martínez | 89 | Serie A TIM | 92k coins | +5.1% | +65.8% | Esticada |
| Gianluigi Donnarumma | 95 | — | 118k coins | +23.6% | +61.9% | Esticada |
| Antoine Semenyo | 91 | Premier League | 101k coins | +2.6% | +55.8% | Momentum moderado |
| Fran Kirby | 88 | — | 92k coins | +33.6% | +54.5% | Esticada |
| Carlos Baleba | 90 | Premier League | 92k coins | +1.6% | +54.2% | Momentum moderado |
| Hristo Stoichkov | 89 | Icons | 105k coins | +14.7% | +51.1% | Momentum moderado |
| Nahuel Molina | 91 | — | 208k coins | +29.7% | +48.7% | Esticada |
| Maya Le Tissier | 88 | Barclays WSL | 84k coins | +8.2% | +44.5% | Momentum moderado |
| Nuno Mendes | 95 | — | 224k coins | +33% | +43.6% | Esticada |
| Caroline Seger | 90 | Icons | 94k coins | +3.3% | +43.1% | Momentum moderado |
| Giorgio Chiellini | 89 | Icons | 128k coins | +36.2% | +42.2% | Esticada |
| Gianluigi Buffon | 91 | Icons | 163k coins | +25.4% | +33.6% | Esticada |
| Harry Kane | 90 | Bundesliga | 196k coins | +38.9% | +29% | Esticada |
| Viktor Gyökeres | 88 | — | 88k coins | +27.6% | +28.5% | Esticada |


## 📈 Análise dos destaques

- **Alessia Russo (90)** — 96k coins, **+69.6% em 7 dias** (+14% em 24h). Preço em linha com a média de 7 dias (+7%). Sem previsão recente válida; acompanhe preço e liquidez para escolher a entrada.
...
- **Gianluigi Donnarumma (95)** — 118k coins, **+61.9% em 7 dias** (+23.6% em 24h). Preço -23% abaixo da média de 7 dias (descontada). Sem previsão recente válida; acompanhe preço e liquidez para escolher a entrada.

- **Antoine Semenyo (91)** — 101k coins, **+55.8% em 7 dias** (+2.6% em 24h). Preço -62% abaixo da média de 7 dias (descontada). Sem previsão recente válida; acompanhe preço e liquidez para escolher a entrada.

- **Fran Kirby (88)** — 92k coins, **+54.5% em 7 dias** (+33.6% em 24h). Preço +34% acima da média de 7 dias (aquecida). Sem previsão recente válida; acompanhe preço e liquidez para escolher a entrada.
...
Alessia Russo (90, sem liga) lidera, com +69.6% em 7 dias a 96k coins no PC. A lista mede momentum e deve ser confirmada com uma cotação atual antes da compra.
...
- [Mercado EA FC em 29/07: Cartas Meta — PC](/posts/mercado-ea-fc-2026-07-29-pc/)

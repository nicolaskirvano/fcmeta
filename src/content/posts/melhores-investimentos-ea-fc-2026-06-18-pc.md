...
title: "Momentum de Cartas Meta no EA FC em 18/06 — PC"
draft: false
featured: true
tags:
  - investimentos
  ...
  - previsoes
  - pc
description: "Ranking histórico de momentum em 18/06/2026 no PC: Matthias Ginter liderou 7d com +73,5%. Compare preços, 24h/7d, gráfico e limites."
---
...
**Matthias Ginter** liderou o recorte com **+73,5% em 7d** e +2,4% em 24h. Entre 15 cartas, 15 tinham as duas janelas positivas; a mediana semanal foi **+59,2%**.

Os preços destacados iam de **85k coins** a **215k coins**. O ranking descreve momentum observado naquela data; previsão ausente ou inválida aparece como N/D e não confirma uma compra atual.

![Gráfico de variação em 7 dias para os destaques de Momentum de Cartas Meta no EA FC em 18/06 — PC](/charts/melhores-investimentos-ea-fc-2026-06-18-pc.svg)
...
| Yan Diomande | 92 | — | 85k coins | +34.9% | +70% | N/D |
...
- **Matthias Ginter (88)** — 85k coins, **+73.5% em 7 dias** (+2.4% em 24h). Preço +28% acima da média de 7 dias (aquecida). O dado registrava momentum positivo; uma entrada atual exige nova validação.

- **Yan Diomande (92)** — 85k coins, **+70% em 7 dias** (+34.9% em 24h). Preço +40% acima da média de 7 dias (aquecida). O dado registrava momentum positivo; uma entrada atual exige nova validação.

- **Paulo Dybala (88)** — 143k coins, **+68.2% em 7 dias** (+22.2% em 24h). Preço +32% acima da média de 7 dias (aquecida). O dado registrava momentum positivo; uma entrada atual exige nova validação.

- **Abedi Pelé (90)** — 161k coins, **+64% em 7 dias** (+4.5% em 24h). Preço +16% acima da média de 7 dias (aquecida). O dado registrava momentum positivo; uma entrada atual exige nova validação.

- **Abedi Pelé (91)** — 185k coins, **+60.9% em 7 dias** (+23.3% em 24h). Preço +35% acima da média de 7 dias (aquecida). O dado registrava momentum positivo; uma entrada atual exige nova validação.
...
Matthias Ginter (88, Bundesliga) lidera, com +73.5% em 7 dias a 85k coins no PC. No recorte, isso descrevia momentum observado, não uma recomendação atual.
...
- [Cartas Meta no EA FC em 18/06: altas e baixas — PC](/posts/mercado-ea-fc-2026-06-18-pc/)
